...
public class PinpointModule extends I2cDeviceSynchDevice<I2cDeviceSynchSimple> {
    ...
    public EncoderDirection invertDirection(EncoderDirection dir) {
        if(dir == EncoderDirection.FORWARD) {
